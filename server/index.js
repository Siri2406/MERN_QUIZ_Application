...
mongoose.connect("mongodb+srv://vennelanarava3:vennelanarava123@first.p2ch5.mongodb.net/quiz?retryWrites=true&w=majority&appName=first")
...
app.post("/api/sendemail", async (req, res) => {
    ...
    const subject = "Assignment Link";
    const message = `
    <h3>Greetings</h3>
    <p>You have been selected for Global Coding Club Assignments Challenge.</p>
    <p>Here is your <a href="http://localhost:3000/user">Assignment Link</a> . Make sure to Answer everything</p>
    <p>Regards</p>
    <p>GCC</p>
`;
